...
<div class="">
    ...
    <div class="mb-3">
        ...
        <div class="p-2 overflow-scroll">
            <p class="m-0 fw-bold" style="white-space: nowrap;">{{ url('api/booking/detail/{booking_id}?access_token=' . env('ACCESS_TOKEN')) }}</p>
        </div>
    </div>
    <div class="">
    ...
    @if(!$bookings->isNotEmpty())
        <p class="m-0 ms-2 fsz-10 text-danger mb-3"><i class="fas fa-exclamation-circle me-1"></i>Data booking masih kosong. Tambah <a href="{{ url('dokumentasi/api/booking/add') }}" class="td-hover">di sini.</a></p>
    @endif
    <div class="d-flex">
        <a href="{{ url('api/booking/detail/' . ($bookings->isNotEmpty() ? $bookings[0]->booking_id : 'booking_id') . '?access_token=' . env('ACCESS_TOKEN')) }}" target="_blank" class="btn btn-success d-block">coba <i class="fas fa-external-link-alt"></i></a>
    </div>
</div>

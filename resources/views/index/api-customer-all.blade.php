...
<div class="">
    ...
    <div class="mb-3">
        ...
        <div class="p-2 overflow-scroll">
            <p class="m-0 fw-bold" style="white-space: nowrap;">{{ url('api/customer/all?access_token=' . env('ACCESS_TOKEN')) }}</p>
        </div>
    </div>
    <div class="">
    ...
    <div class="d-flex">
        <a href="{{ url('api/customer/all?access_token=' . env('ACCESS_TOKEN')) }}" target="_blank" class="btn btn-success d-block">coba <i class="fas fa-external-link-alt"></i></a>
    </div>
</div>

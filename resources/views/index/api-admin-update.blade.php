    ...
    <form action="{{ url('api/admin/add') }}" method="post">
        ...
        <div class="mb-3">
            ...
            <div class="p-2 overflow-scroll">
                <p class="m-0 fw-bold" style="white-space: nowrap;">{{ url('api/admin/update') }}</p>
            </div>
        </div>
        <div class="">
            ...
            <ul>
                ...
                <li>
                    ...
                    <input type="text" name="admin_fullname" class="form-control" placeholder="..." value="Muhammad Raffi Ghifari">
                </li>
                <li>
                    <p class="m-0">admin_email</p>
                    <input type="text" name="admin_email" class="form-control" placeholder="..." value="rafi@gmail.com">
                </li>
                <li>

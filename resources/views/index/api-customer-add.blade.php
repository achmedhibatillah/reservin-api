        ...
        <div class="">
            ...
            <ul>
                ...
                <li>
                    ...
                    <input type="text" name="customer_fullname" class="form-control" placeholder="..." value="Achmed Hibatillah">
                </li>
                <li>
                    <p class="m-0">customer_email</p>
                    <input type="text" name="customer_email" class="form-control" placeholder="..." value="contact@achmedhibatillah.com">
                </li>
                <li>

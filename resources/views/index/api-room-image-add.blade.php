...
<hr>
<div class="">
    <form action="{{ url('api/room-image/add') }}" method="post">
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <div class="p-2 overflow-scroll">
                <p class="m-0 fw-bold" style="white-space: nowrap;">{{ url('api/room-image/add') }}</p>
            </div>
        </div>
        <div class="">
            ...
            <ul>
                ...
                <li>
                    <p class="m-0">ri_image</p>
                    <input type="text" name="ri_image" class="form-control" placeholder="..." value="nama-file.png">
                </li>
                <li>
